...
const UserProfile = () => {
    ...
    const fetchQuestions = async () => {
        try {
            const response = await fetch("https://query-me-api.onrender.com/question/own", {
                method: "GET",
                headers: {
    ...
    const answerQuestion = async (e, questionId) => {
        ...
        try {
            ...
            const response = await fetch(`https://query-me-api.onrender.com/question/answer/${questionId}`, {
                method: "POST",
                headers: {
                    'content-type': 'application/json',
                    'Authorization': `Bearer ${user.token}`
